...
@Component	//매물 PROPERTY
public class Bang implements java.io.Serializable{

	private static final long serialVersionUID = 3330L;
	...
	public Bang(int pro_no, String id, String pro_address, String pro_detail, int deposit, int rent, int manage_pay,
			...
			String pro_content, String contract_yn, String pro_del, Date del_date) {
		this.pro_no = pro_no;
		this.id = id;
	...
	public String toString() {
		return "Bang [pro_no=" + pro_no + ", id=" + id + ", pro_address=" + pro_address + ", pro_detail=" + pro_detail
